...
title: "How Optimizely's Classic Android SDK Works"
summary: |
   Learn about how Optimizely's Classic Android SDK Order of execution, experiment activation, and goals.
...
# How Optimizely's Classic Android SDK Works

*THIS ARTICLE WILL HELP YOU:*
- Understand *how Optimizely's Classic SDK executes* in an app
- Understand the *order of operations* for how an experiment runs
- *Use Optimizely's Classic Android APIs* to provide visibility into what experiments are running
