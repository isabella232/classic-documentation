...
<!-- This ^^ (#registering-your-app) currently links to an Optimizely X page. This needs to be verified to be accurate. If it is, this page should either explicitly state that the visitor will be redirected or the contents should be duplicated. -->
...
<h3 id="snippet-create-a-developer-account">1. Log in to your Optimizely account</h3>
